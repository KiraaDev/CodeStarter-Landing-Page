...
function HeroSection() {
    ...
    return (
        <section className="relative h-[65svh] flex justify-center items-center flex-col gap-10 rounded-md bg-gradient-to-t from-[#56a5efd4] to-[#fafafa4d]  overflow-hidden md:h-[70svh]">
