...
function HeroSection() {
    ...
    return (
        <section className="relative h-[65svh] flex justify-center items-center flex-col gap-10 rounded-md bg-gradient-to-t from-[#4e80afd4] to-[#fafafa4d]  overflow-hidden md:h-[70svh]">
            <div
            ...
            <div className=" z-1 shadow-2xl rounded-md h-60 w-[60%] absolute bottom-[-10px]">
